...
accordionBtns.forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        if (!isOpen) {
            ...
            // Forzar visibilidad de elementos reveal dentro del acordeón
            // (el IntersectionObserver no los detecta cuando están ocultos)
            content.querySelectorAll('.reveal, .scale-reveal').forEach(el => {
